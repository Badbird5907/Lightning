...
dependencies {
    implementation 'net.badbird5907:Lightning:1.1.0-REL'
}
```

[Maven Search](https://search.maven.org/artifact/net.badbird5907/Lightning/1.1.0-REL/jar)
